...
function countingSort(arr) {
    ...
    // create a new array that is the length of arr, initialize all elements to 0 with the fill method

    for (let i = 0; i < arr.length; i++) {
        res[arr[i]] += 1;

        // iterate through arr
        // for each value of arr[i], increment the corresponding index in the 'res' array by 1
        // this counts the occurrences of each value in 'arr' and stores the count in the 'res' array
    }

    return res.slice(0, 100)
    // return the res arr, sliced because of the 0 <= arr[i] < 100 constraint
}
