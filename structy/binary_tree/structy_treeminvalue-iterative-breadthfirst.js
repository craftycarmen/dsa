...
// 2. create a constant variable called queue with the root passed into an array
// 3. while there is a queue:
//      a. create a constant variable called current that removes the front element of queue via .shift()
...
// n = number of nodes
// time complexity: O(n2) technically because of .shift() --> if you remove the front element of an array in JS, you will have to shift all the other elements over one position
